...
class RumahAdapter(private var data: List<Rumah>,
                     private val listener: (Rumah) -> Unit)
    : RecyclerView.Adapter<RumahAdapter.LeagueViewHolder>() {
    ...
    class LeagueViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItem(data: Rumah, listener: (Rumah) -> Unit, context : Context, position : Int) {
