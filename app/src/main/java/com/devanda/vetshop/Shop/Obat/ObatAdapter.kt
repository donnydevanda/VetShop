...
class ObatAdapter(private var data: List<Obat>,
                     private val listener: (Obat) -> Unit)
    : RecyclerView.Adapter<ObatAdapter.LeagueViewHolder>() {
    ...
    class LeagueViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItem(data: Obat, listener: (Obat) -> Unit, context : Context, position : Int) {
